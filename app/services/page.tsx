  ...
  return (
    <main style={{ background: "#0A1628", minHeight: "100vh" }}>
      ...
      <PageHeader
        ...
        title={<>Our <span style={{ color: "#C4A882" }}>Services</span></>}
        description="End-to-end real estate expertise — from discovery to closing — tailored to your lifestyle and goals."
      />
      ...
      <section className="pb-24 px-5 sm:px-6 lg:px-12 max-w-7xl mx-auto">
        <div className="space-y-0">
          {services.map((service) => (
            ...
            >
              <span
                className="text-5xl sm:text-7xl font-black leading-none shrink-0 transition-colors duration-300 group-hover:text-[#8B6347]"
      ...
      <section className="pb-24 sm:pb-32 px-5 sm:px-6 lg:px-12 max-w-7xl mx-auto">
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4 sm:gap-8">
          {stats.map((stat) => (
            <div key={stat.label} className="text-center py-6 sm:py-8 border rounded-2xl"
